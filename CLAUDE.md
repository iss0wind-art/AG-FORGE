...
- [x] **V3 Life Guard → generation_node 연결** — shadow 모드 활성 (방부장 승인 2026-04-28, 환생 시스템 연동 후 enforce 전환)
...
- [x] **단군↔피지수 양방향 MCP 브리지** — physis_ask_dangun(피→단), dangun_ask_physis(단→피) 구현 완료 (2026-04-28)
