...
# FREECAD_docs_MANUAL_DRAWING_TO_FREECAD_v3

> 출처: `FreeCAD_4TH/docs/MANUAL_DRAWING_TO_FREECAD_v3.md` — 3지국 FreeCAD (이천) 자동 흡수
> 흡수일: 2026-05-09
...
|---|---:|---|---|
| 지하주차장 슬라브 | **150** | S40-051~

... (잘림 — 원본: `/home/nas/FreeCAD_4TH/docs/MANUAL_DRAWING_TO_FREECAD_v3.md`)
