...
# H2OWIND_docs_REVAMP_PLAN_2026-04-26

> 출처: `H2OWIND_2/docs/REVAMP_PLAN_2026-04-26.md` — 2지국 H2OWIND (이순신) 자동 흡수
> 흡수일: 2026-05-09
...
- `drizzle/0006_add_daily_tables.sql` 작성:
  ...
  CREATE TABLE IF NOT EXISTS DailyWorker (
    ...
    manday REAL DEFAULT 1.0,
    workContent TEXT,
    section TEXT,
    source TEXT,
    createdAt TEXT DEFAULT (datetime('now'))
  );
  CREATE UNIQUE INDEX IF NOT EXISTS idx_daily_worker_unique
    ON DailyWorker(date, workerName, source);
...
- `npx drizzle-kit push` 실행으로 운영 DB에 반

... (잘림 — 원본: `/home/nas/H2OWIND_2/docs/REVAMP_PLAN_2026-04-26.md`)
