...
# FREECAD_spec_PHASE0_REVIEW_DECISIONS

> 출처: `FreeCAD_4TH/spec/PHASE0_REVIEW_DECISIONS.md` — 3지국 FreeCAD (이천) 자동 흡수
> 흡수일: 2026-05-09
...
|------|---|
| **결재** | **이미 결정 — 봉인** |
| **내용** | `members` 테이블 PK = `(project_id, instance_id)` 복합. 같은 프로젝트 내 유일성만 보장

... (잘림 — 원본: `/home/nas/FreeCAD_4TH/spec/PHASE0_REVIEW_DECISIONS.md`)
